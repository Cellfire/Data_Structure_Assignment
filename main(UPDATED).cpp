...
int main()
{
    ...
    do
    {
        ...
        case 7:
        {
            ...
            // Time results
            auto arrayTime = std::chrono::duration_cast<std::chrono::nanoseconds>(endArray - startArray).count();
            auto listTime = std::chrono::duration_cast<std::chrono::nanoseconds>(endList - startList).count();

            std::cout << "\n=== TIME DIFFERENCE ===\n";
            std::cout << "Array Traversal Time: " << arrayTime << " ns\n";
            std::cout << "List  Traversal Time: " << listTime << " ns\n";

             if (arrayTime < listTime)
                 std::cout << "[RESULT]  Array traversal is faster.\n";
            else if (listTime < arrayTime)
                std::cout << "[RESULT]  Linked List traversal is faster.\n";
             else
                std::cout << "[RESULT]  Equal performance.\n";
            ...
            if (arrayMem < listMem)
                std::cout << "[RESULT]  Array is more memory efficient.\n";
            else if (listMem < arrayMem)
                std::cout << "[RESULT]  Linked List is more memory efficient.\n";
            else
                std::cout << "[RESULT]  Equal memory usage.\n";
